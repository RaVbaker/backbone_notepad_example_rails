...
# config.action_view.javascript_expansions[:defaults] = %w(jquery.min underscore.min json2 backbone.min)   
...
# edytujemy pliki: config/routes.rm dodając: resources :notes, :format => :json, aby domyślny format był JSONem:
...
# usuwamy domyslny szablon
rm public/index.html

# tworzymy kontroler dla strony offline-owej
